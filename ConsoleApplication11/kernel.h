...
enum class alpha : WORD {
	ZER=0x30, ONE=0x31, TWO=0x32, THR=0x33,
	FOU=0x34, FIV=0x35, SIX=0x36, SEV=0x37,
	EIG=0x38, NIN=0x39, 
...
private:
	...
	{'0', alpha::ZER}, {'1', alpha::ONE}, {'2', alpha::TWO}, {'3', alpha::THR},
	{'4', alpha::FOU}, {'5', alpha::FIV}, {'6', alpha::SIX}, {'7', alpha::SEV},
	{'8', alpha::EIG}, {'9', alpha::NIN},
